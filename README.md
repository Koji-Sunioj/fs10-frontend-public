...
app deployed on: https://magnificent-mochi-99378f.netlify.app/

features:

1. ability to filter the table via typing 
2. sorting columns 
3. add or remove products in a cart
4. a sidepanel showing the cart items
5. toggle of light or dark theme
